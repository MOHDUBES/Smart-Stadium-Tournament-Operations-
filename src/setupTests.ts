...
vi.mock('framer-motion', () => ({
  motion: {
    ...
    h2: ({ children, ...props }: React.PropsWithChildren<Record<string, unknown>>) => React.createElement('h2', props as React.HTMLAttributes<HTMLHeadingElement>, children),
    h3: ({ children, ...props }: React.PropsWithChildren<Record<string, unknown>>) => React.createElement('h3', props as React.HTMLAttributes<HTMLHeadingElement>, children),
  },
