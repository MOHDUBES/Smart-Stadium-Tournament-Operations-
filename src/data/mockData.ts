...
export const mockStadiumData: StadiumData = {
  ...
  amenities: [
    { id: 'food-1', name: 'Classic Burgers', type: 'food', waitTimeMinutes: 15, location: 'Near Gate 3' },
    { id: 'food-2', name: 'Vegan Delights', type: 'food', waitTimeMinutes: 2, location: 'Near Gate 1' },
    { id: 'rest-1', name: 'Restroom (Sector 4)', type: 'restroom', waitTimeMinutes: 8, location: 'Sector 4 Concourse' },
    { id: 'rest-2', name: 'Restroom (VIP)', type: 'restroom', waitTimeMinutes: 0, location: 'Sector 1' },
  ],
  incidents: [
    { id: 'inc-1', title: 'Spill on Concourse B', status: 'active', timeAgo: '10m', type: 'maintenance' },
    { id: 'inc-2', title: 'Medical Assist (Sect 2)', status: 'resolved', timeAgo: '1h', type: 'medical' },
  ],
  overallCrowd: {
    totalFans: 42500,
    capacityPercent: 85,
